...
public class ThrowBack extends ApplicationPageBase {
    ...
    WebElement amazing;
    @FindBy(xpath = "//*[@id=\'main\']/div[1]/div/section/section/div[2]/div/div[4]/section/div/div[2]/a[3]/article/div[2]/div[1]")
    WebElement average;
    @FindBy(xpath = "//*[@id=\'main\']/div[1]/div/section/section/div[2]/div/div[4]/section/div/div[2]/a[4]/article/div[2]/div[1]")
    WebElement battlestar;
    @FindBy(xpath = "//*[@id=\'main\']/div[1]/div/section/section/div[2]/div/div[4]/section/div/div[2]/a[5]/article/div[2]/div[1]")
    WebElement bionic;
